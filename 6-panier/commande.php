          ...
          <div class="content">
              ...
              <section class="right">
                ...
                -->
                    ...
                    <?php 
                    $query_panier= "SELECT * FROM `commande` where `Id_client`=$user_id";    
                    $resultat_panier = $link->query($query_panier); 

                    $query_panier11= "SELECT * FROM `commande` where `Id_client`=$user_id";    
                    $resultat_panier11 = $link->query($query_panier11); 
