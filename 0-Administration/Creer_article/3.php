...
$execut_select = "SELECT * FROM `article` WHERE Type=3";// A faire la requete SQL avec $valeur_prix de choix article pour trie uniquement avec type d'objet
...
<head>
  ...
  <title>Création de RAM : </title>
</head>
<body>
  <header>
    <h1>Création de RAM :</h1>
  </header>
  
  <section>
    <form action="3_.php" method="POST">
    <fieldset >
