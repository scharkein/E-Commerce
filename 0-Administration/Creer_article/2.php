...
$execut_select = "SELECT * FROM `article` WHERE Type=2";// A faire la requete SQL avec $valeur_prix de choix article pour trie uniquement avec type d'objet
...
<head>
  ...
  <title>Création d'un processeur' : </title>
</head>
<body>
  <header>
    <h1>Création d'un processeur :</h1>
  </header>
  
  <section>
    <form action="2_.php" method="POST">
    <fieldset >
