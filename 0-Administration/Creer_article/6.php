...
$execut_select = "SELECT * FROM `article` where Type=6";// A faire la requete SQL avec $valeur_prix de choix article pour trie uniquement avec type d'objet
...
<head>
  ...
  <title>Création d'un boitier : </title>
</head>
<body>
  <header>
    <h1>Création d'un boitier :</h1>
  </header>
  
  <section>
    <form action="6_.php" method="POST">
    <fieldset >
