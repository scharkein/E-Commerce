...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO `article` (`Id_article`, `Type`, `Name`, `Description`, `Marque`,`Gamme`, `Quantité`, `Prix_revient`, `Prix_vente`, `Critere_1`, `Critere_2`, `Critere_3`, `Critere_4`) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($link, $query);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "isssssddssss", $type, $nom, $desc, $marque, $gamme, $quantite, $p_revient, $p_vente, $Critere_1, $Critere_2, $Critere_3,$Critere_4);
