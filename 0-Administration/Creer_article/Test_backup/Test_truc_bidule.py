...
#takeown /f "E:\Uwamp\UwAmp\www\Commerce\0-Administration\Creer_article\Envoi_csv.py"
...
repertoire="E:\\OneDrive\\Site_web\\UwAmp\\www\\Commerce\\2-Article\\blablablabdqdqdqla.php"
...
$quer="SELECT * FROM article where Id_article="; // Trie par ordre décroissant et prend QUE la première valeur 
...
caca(contenu_html,repertoire)
caca(contenu_html+"2222",repertoire)
