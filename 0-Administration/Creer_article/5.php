...
$execut_select = "SELECT * FROM `article` WHERE Type=5";// A faire la requete SQL avec $valeur_prix de choix article pour trie uniquement avec type d'objet
...
<head>
  ...
  <title>Création de stockage : </title>
</head>
<body>
  <header>
    <h1>Création de stockage :</h1>
  </header>
  
  <section>
    <form action="5_.php" method="POST">
    <fieldset >
    ...
    Type (SSD/disque dur)<br><select name="Critere_1">
