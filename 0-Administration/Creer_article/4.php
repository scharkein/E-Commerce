...
$execut_select = "SELECT * FROM `article` WHERE Type=4";// A faire la requete SQL avec $valeur_prix de choix article pour trie uniquement avec type d'objet
...
<head>
  ...
  <title>Création d'une Carte mère : </title>
</head>
<body>
  <header>
    <h1>Création d'une Carte mère :</h1>
  </header>
  
  <section>
    <form action="4_.php" method="POST">
    <fieldset >
