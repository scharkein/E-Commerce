...
$execut_select = "SELECT * FROM `article` where Type=1";    // A faire la requete SQL avec $valeur_prix de choix article pour trie uniquement avec type d'objet
...
<head>
  ...
  <title>Création d'une Carte Graphique : </title>
</head>
<body>
  <header>
    <h1>Création d'une Carte Graphique :</h1>
  </header>
  
  <section>
    <form action="1_.php" method="POST">
    <fieldset >
  ...
  <?php afficherOptions($resultat, 'Critere_3', 'Critere_3'); ?>
    ...
    RGB Var 50 <br><input type="text" name="Critere_4"><br>
